...
public class ReservationDao {
    ...
    public boolean add(Reservation reservation) {
        ...
        try {
            ...
            preparedStatement.setInt(6, reservation.getAdultNumber());
            preparedStatement.setInt(7, reservation.getChildNumber());
            preparedStatement.setString(8, reservation.getCustomerNote());
            preparedStatement.setInt(9, reservation.getTotalPrice());
